...
INSERT INTO `habilidad` VALUES (1,'CENTRO DE INFORMACIÓN','SII',5),(1,'DEPTO. DE DESARROLLO ACADÉMICO E IDIOMAS','SITIO WEB',1),(1,'DEPTO. DE INGENIERÍA  ELECTRÓNICA','SITIO WEB',2),(1,'DEPTO. DE INGENIERÍA  ELECTRÓNICA  MECÁNICA','OTRO',3),(1,'DEPTO. DE INGENIERÍA  MECÁNICA','SITIO WEB',2),(1,'DIRECCIÓN','SII',2),(1,'DIRECCIÓN','SITIO WEB',2),(1,'M-Electrónica','SITIO WEB',1),(2,'CENTRO DE INFORMACIÓN ','EXAMEN EN LINEA',3),(2,'D-Computación','MT.PREVENTICO',3),(2,'D-Electrónica','CORREO',2),(2,'DEPTO. DE INGENIERÍA  ELECTRÓNICA','SOFTWARE',3),(2,'DEPTO. DE SERVICIOS ESCOLARES','PROGRAMACION',1),(2,'M-Computación','SII',1),(2,'SUBDIRECCIÓN DE SERVICIOS ADMINISTRATIVOS','REDES',2),(3,'','EXAMEN EN LINEA',1),(3,'','REDES',3),(3,'DEPTO. DE CIENCIAS COMPUTACIONALES','SITIO WEB',3),(3,'SUBDIRECCIÓN ACADÉMICA','MT.PREVENTICO',1),(4,'','EQUIPO DE COMPUTO',4),(4,'','EXAMEN DE ADMISION',1),(4,'','PROGRAMACION',1),(4,'','REDES',3),(4,'','REUNIONES DIFUSION',1),(4,'','SOFTWARE',1),(4,'AUXILIAR ADMINISTRATIVO','SITIO WEB',3),(4,'DEPTO. DE  COMUNICACIÓN Y EVENTOS','CORREO',2),(4,'DEPTO. DE CIENCIAS COMPUTACIONALES','SITIO WEB',1),(4,'DEPTO. DE DESARROLLO ACADÉMICO E IDIOMAS','REDES',1),(4,'DEPTO. DE INGENIERÍA  ELECTRÓNICA','SITIO WEB',4),(4,'SUBDIRECCIÓN ACADÉMICA','MT.PREVENTICO',1);
...
INSERT INTO `registro` VALUES (1,' l15091012@zacatepec.tecnm.mx',NULL,'IMPRESORA','Espera','2021-05-19 17:10:58',NULL,NULL,NULL,0),(2,' l15091012@zacatepec.tecnm.mx',NULL,'EQUIPO DE COMPUTO','Espera','2021-05-19 17:15:53',NULL,NULL,NULL,0),(3,' altep@cenidet.edu.mx',NULL,'SII','Espera','2021-05-19 17:19:03',NULL,NULL,NULL,1),(4,'l15091012@zacatepec.tecnm.mx',NULL,'EQUIPO DE COMPUTO','Espera','2021-05-19 17:30:28',NULL,NULL,NULL,0),(5,'l15091012@zacatepec.tecnm.mx',NULL,'SII','Espera','2021-05-19 17:31:10',NULL,NULL,NULL,0),(6,'l15091012@zacatepec.tecnm.mx',NULL,'INTERNET','Espera','2021-05-21 10:02:17',NULL,NULL,NULL,0),(7,'l15091012@zacatepec.tecnm.mx',NULL,'IMPRESORA','Espera','2021-05-21 10:04:07',NULL,NULL,NULL,0),(8,'l15091012@zacatepec.tecnm.mx',NULL,'IMPRESORA','Espera','2021-05-21 10:05:10',NULL,NULL,NULL,0),(9,'l15091012@zacatepec.tecnm.mx',4,'SITIO WEB','Asignado','2021-05-21 10:05:12',NULL,NULL,NULL,1);
...
INSERT INTO `tecnico` VALUES (1,'Alfonso','D´Granda','Trejo','Alfonso.grtr@cenidet.tecnm.mx',1),(2,'Alfredo',' Terrazas',' Porcayo','elfredo.trpo@cenidet.tecnm.mx',1),(3,'Cecilia',' Lopez',' Romero','cecilia.loro@cenidet.tecnm.mx',1),(4,'Hector',' Figueroa ','Cisneros','hector.cishe@cenidet.tecnm.mx',1),(5,'Josué',' Ruiz',' Martinez','jose.RuMar@cenidet.tecnm.mx',1),(6,'Carlos','flores','Montes','carlos_flores@hotmail.com',1);
/*!40000 ALTER TABLE `tecnico` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'solicitud'
--

--
-- Dumping routines for database 'solicitud'
--
/*!50003 DROP PROCEDURE IF EXISTS `Activacion` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Activacion`(in  _Correo varchar(30))
BEGIN 
declare Correo int default 0;

SELECT max(reg.idRegistro) into Correo from registro reg where reg.CorreoSolic=_Correo;
if Correo>0 THEN 
UPDATE registro  SET Activacion=1 WHERE  idRegistro=Correo ;
     call UPDATETECNICO();
END IF;
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `Liberacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Liberacion`(in _Correo varchar(30),_calificacion int, _comentario varchar(200))
BEGIN 
set @estado=(select statusS from registro where   CorreoSolic=_Correo order by CorreoSolic desc limit 1);

if @estado in ("Asignado") then
UPDATE registro set statuss="Liberado",valoracion=_calificacion,comentario=_comentario,FechaL=now() where statusS="Asignado" and  CorreoSolic=_Correo order by CorreoSolic desc limit 1;
select 0 as estado;
elseif @estado in ("Liberado") then
select 1 as estado;
elseif @estado in ("Espera") then
select 2 as estado;
end if;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `liberation` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `liberation`(in  _id int,in _valoration  int ,in _comentario varchar (250))
BEGIN 
...
BEGIN 
declare cont int default 0; -- contrar id estan disponibles libres
declare idrb varchar(30) default "0"; -- contrar id estan disponibles libres
declare contN int default 0; -- contrar id estan disponibles libres

	SET @IDB=(SELECT count(idregistro) from registro2 where activacion=1 and statusS="Espera"  ); /*buscar numero de idregistro que este en espera*/
    
if @IDB>0 then				/* Si hay registros en espera*/
    while cont<@IDB do  -- pasar por cada uno
		SET @IDR=(SELECT idregistro from registro2 where activacion=1 and statusS="Espera" and idregistro not  in(idrb) limit 1); /*buscar idregistro que este en espera*/
		...
		SELECT es.Area  from Estudiante es WHERE Correo=@correo limit 1);
			...
			SET @IDT=(select tec.idtecnico  from tecnico tec inner join habilidad hab on tec.idtecnico=hab.idtecnico WHERE Habilidad=@tipo
				...
				order by Prioridad desc limit 1);			
							...
							if @IDT>0 then		-- si hay tecnico
						              UPDATE REGISTRO2 SET idtecnico=@IDT, statusS="Asignado" where idRegistro=@IDR ;    
									select "Asignacion correcta";
                        
							else
                                 select concat("Tecnicos no Escontrados idR "+idrb);
									 if contN=0 then
									 set idrb=concat(idrb," or ",@IDR);
									 elseif contN>0 then
									 set idrb=concat(idrb," or ",@IDR);
									 end if;
									set contN=contN+1;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `register_request` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `register_request`(in _TypeSer varchar(25), in  _Correo varchar(30))
BEGIN
 INSERT INTO registro (CorreoSolic,TipoS,FechaR) values (_Correo,_TypeSer ,now());
 END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `registractionSolcitud` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `registractionSolcitud`(in _TypeSer varchar(25), in  _Correo varchar(30),in _token varchar(30))
BEGIN
declare id int default 0;
SET @id_estudiante = (SELECT idEstudiante FROM Estudiante where Correo=_Correo);
 IF @id_estudiante>0 then 
 INSERT INTO Registro (idEstudiante,TipoS,FechaR) values ( @id_estudiante,_TypeSer ,date(now()));
 select max(idRegistro) into id from Registro ;
 INSERT INTO TOKEN(idRegistro,token) VALUE(id,_token);
 end if;
 END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UPDATETECNICO` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATETECNICO`()
BEGIN 
SET @ID=(SELECT max(idRegistro) from registro where activacion=1 and statusS="Espera" order by idregistro asc ); /*buscar idregistro que este en espera*/

if @ID>0 then
	SET @tipo=(SELECT tipoS   from registro  where idRegistro=@ID limit 1)  ;
	SET @correo=(SELECT correoSolic  from registro  where idRegistro=@ID limit 1);
	SET @Area=(SELECT em.adscripcion from Empleado em WHERE Correo=@correo
	union
	SELECT es.Area  from Estudiante es WHERE Correo=@correo limit 1);

	SET @IDT=(select tec.idtecnico  from tecnico tec inner join habilidad hab on tec.idtecnico=hab.idtecnico WHERE Habilidad=@tipo
		and tec.idTecnico not in(select idTecnico from registro where statusS="Asignado" and tipoS=@tipo
		group by  idTecnico ) and   departamento in (@Area )
		order by Prioridad asc limit 1);
			if @IDT>0 then
		--
        select concat(Nombre," ",ApellidoP," ",ApellidoM) as Nombre ,"1" as Asignacion  from tecnico tec inner join habilidad hab on tec.idtecnico=hab.idtecnico WHERE Habilidad=@tipo
		and tec.idTecnico not in(select idTecnico from registro where statusS="Asignado" and tipoS=@tipo
		group by  idTecnico ) and   departamento in (@Area )
		order by Prioridad asc limit 1;
        UPDATE registro SET idtecnico=@IDT, statusS="Asignado" where idRegistro=@ID ;    
        
        --
		else
           select "" as Nombre, "0"  as Asignacion;
        end if;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Vereficacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Vereficacion`(in _Correo varchar(30))
BEGIN 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `VereficacionTec` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `VereficacionTec`(in _Correo varchar(30))
BEGIN 
	SET @PEOPLE_TEC=(SELECT Correo from tecnico WHERE Correo=_Correo and status=1);
...
-- Dump completed on 2021-05-24 13:33:02
